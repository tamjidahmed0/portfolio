  ...
  return (
    <div className="px-9 py-10">
      <div className="flex flex-col lg:flex-row gap-[20px] lg:items-start">
        ...
        <div className="lg:w-[30%] bg-white lg:sticky lg:top-0 px-5 py-10 rounded-xl">
          <div className="relative h-80 bg-gray-300 rounded-xl overflow-hidden animate-pulse">
        ...
        <div className="lg:w-[70%] bg-white p-9 rounded-xl">
          {/* Blog Title Skeleton */}
          ...
          <div className="mt-10">
            <div className="animate-pulse">
              <div className="h-6 bg-gray-300 w-1/4 rounded mb-5"></div>
