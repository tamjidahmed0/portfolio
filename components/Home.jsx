        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-[20px]">
          {aboutData?.skillsdescription?.map((value, index) => (
            ...
            >
             ...
             <div className="text-[25px]  lg:text-[35px]"> <Icon icon={value.icons.name} color={value.iconColor.value} /></div>
                <span className=" capitalize text-[15px]  lg:text-[24px] ">{value?.title}</span>
              </div>
